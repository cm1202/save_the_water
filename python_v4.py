...
def show_graph():
    messagebox.showinfo("Graph", "Display your graph here.")
...
graph_button = customtkinter.CTkButton(profile_frame, text="Graph", command=show_graph)
graph_button.place(relx=0.5, rely=0.5)
