...
class User:
    def __init__(self, shower_minutes, showers_per_week, toilet_flushes, faucet_minutes, dishwasher_loads, washing_machine_loads):
...
def add_profile():
    ...
    global profile_shower_minutes_var, profile_showers_per_week_var, profile_toilet_flushes_var, profile_faucet_minutes_var, profile_dishwasher_loads_var, profile_washing_machine_loads_var
    ...
    ttk.Label(profile_window, text="Minutes spent in shower daily:").grid(row=0, column=0, padx=10, pady=10)
    profile_shower_minutes_entry.grid(row=0, column=1, padx=10, pady=10)
    ttk.Label(profile_window, text="Showers per week:").grid(row=1, column=0, padx=10, pady=10)
    profile_showers_per_week_entry.grid(row=1, column=1, padx=10, pady=10)
    ttk.Label(profile_window, text="Toilet flushes per day:").grid(row=2, column=0, padx=10, pady=10)
    profile_toilet_flushes_entry.grid(row=2, column=1, padx=10, pady=10)
    ttk.Label(profile_window, text="Minutes spent with faucet on daily:").grid(row=3, column=0, padx=10, pady=10)
    profile_faucet_minutes_entry.grid(row=3, column=1, padx=10, pady=10)
    ttk.Label(profile_window, text="Dishwasher loads per week:").grid(row=4, column=0, padx=10, pady=10)
    profile_dishwasher_loads_entry.grid(row=4, column=1, padx=10, pady=10)
    ttk.Label(profile_window, text="Washing machine loads per week:").grid(row=5, column=0, padx=10, pady=10)
    profile_washing_machine_loads_entry.grid(row=5, column=1, padx=10, pady=10)
    ttk.Button(profile_window, text="Save Profile", command=add_profile_data).grid(row=6, column=0, columnspan=2, pady=10)
...
def add_profile_data():
    ...
    users.append(user)
    profile_select['values'] = [i+1 for i in range(len(users))]
