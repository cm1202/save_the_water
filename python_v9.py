...
def start_game():
    ...
    quit_button_x = screen_width - quit_button_width - 10
    quit_button_y = 10
    quit_button_surf = pygame.Surface((quit_button_width, quit_button_height))
    quit_button_surf.fill(red)
    quit_button_text = font.render("Quit", True, white)
    quit_button_text_pos = quit_button_text.get_rect(center=(quit_button_width//2, quit_button_height//2))
    quit_button_surf.blit(quit_button_text, quit_button_text_pos)
